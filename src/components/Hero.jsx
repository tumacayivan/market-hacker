  ...
  return (
    <header className="relative flex min-h-[100dvh] flex-col justify-end overflow-hidden bg-black px-5 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-4 sm:px-8 lg:px-10 xl:px-14">
      ...
      >
        ...
        <article
          className="w-full max-w-lg rounded-sm border border-white/25 bg-gradient-to-t from-white/[0.72] via-white/[0.18] to-transparent p-4 shadow-[0_-10px_44px_rgba(255,255,255,0.14),0_-2px_20px_rgba(0,0,0,0.06)] backdrop-blur-xl sm:p-5 lg:max-w-[min(100%,440px)]"
